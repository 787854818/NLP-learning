...
class ParserModel(nn.Module):
    ...
    def embedding_lookup(self, w):
        ...
        w_flatten = w.view(w.size()[0] * self.n_features)
        x = torch.index_select(self.embeddings, 0, w_flatten)
    ...
    def forward(self, w):
        ...
        hidden = nn.functional.relu(torch.matmul(x, self.embed_to_hidden_weight) + self.embed_to_hidden_bias)
